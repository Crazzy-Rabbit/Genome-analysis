...
- [RNA SNP calling pipeline](# RNA SNP calling pipeline)
  - [1 STAR比对](# 1.STAR比对)
  - [2 picard加头排序标记重复](# 2.picard加头排序标记重复)
